defmodule FoodTrackerWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: FoodTrackerWeb.Gettext
  ...
  def input(assigns) do
    ...
    <div>
      ...
      <input
        ...
        class={[
          "w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-emerald-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FoodTrackerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FoodTrackerWeb.Gettext, "errors", msg, opts)
    end
  end
