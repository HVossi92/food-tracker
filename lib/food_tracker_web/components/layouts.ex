defmodule FoodTrackerWeb.Layouts do
  @moduledoc """
  ...
  layout on both `use FoodTrackerWeb, :controller` and
  `use FoodTrackerWeb, :live_view`.
  """
  use FoodTrackerWeb, :html

  # Explicitly embed each template to ensure they're found
        ...
        <div class="container mx-auto px-4 py-3">
          <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-2">
              ...
              <!-- Mobile menu button -->
              <button class="md:hidden p-2 rounded-md text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-6 w-6"
                  fill="none"
